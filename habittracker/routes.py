...
pages = Blueprint("habits",__name__,template_folder="emplates",static_folder="static")
...
def today_at_midnight():
    ...
    return datetime.datetime(today.year, today.month, today.day) # by default, hour,min,sec are 0
...
def add_habit():
    ...
    #if the form was subbmitted then handle..."
